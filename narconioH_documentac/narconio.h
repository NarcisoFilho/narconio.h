...
//### INICIALIZAÇÃO ═══════════════════════════════════════════
         ...
         *      Ativa o padrão ANSi caso não o esteja. Além disso adiciona um título
         *      e define as dimensões da janela
         * \param char* : Título do programa
         * \param int : Largura da tela em colunas
         * \param int : Altura da tela em linhas
         * \return void
         *
         * @attention Sempre inclua essa função antes de usar outros comandos da narconio.h
         * @see finalizarJanela()
         */
        void inicializarJanela( /*char* titulo , int larg , int altu*/ );           // Inicializa a janela ANSI
